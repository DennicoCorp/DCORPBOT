...
def send_welcome(message: telebot.types.Message):
    ...
    welcome_text = (
        ...
        f"Я бот с доступом к мощной нейросети <i>[Название Нейросети или описание]</i>. "
        f"Я помогу тебе <i>[пример 1: генерировать тексты]</i>, <i>[пример 2: отвечать на вопросы]</i> и много чего еще!\n\n"
